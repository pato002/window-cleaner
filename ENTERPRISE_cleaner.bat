...
.\LGPO_30\LGPO.exe /t .\Common\LGPO-settings\OnlyENT\NoDiagData.txt
...
:: Disable all personalized recommendations
.\LGPO_30\LGPO.exe /t .\Common\LGPO-settings\OnlyENT\NoPersonalRecommend.txt

:: Disable Windows Spotlight together with all its annoying features
.\LGPO_30\LGPO.exe /t .\Common\LGPO-settings\OnlyENT\NoSpotlight.txt

:: Do not show any Windows tips
.\LGPO_30\LGPO.exe /t .\Common\LGPO-settings\OnlyENT\NoWindowsTips.txt
